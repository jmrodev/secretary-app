                    ...
                    <div className={shared.AnimateFadeIn}>
                        ...
                        <div className={styles.IntegrationRemoteAccess__guide}>
                            ...
                            <ol className={styles.IntegrationRemoteAccess__guideList}>
                                ...
                                <li>{t('duckdns_guide_step2_p1')} <b>{t('integration_token_label')}</b> {t('duckdns_guide_step2_p2')} <b>{t('subdomain')}</b> {t('duckdns_guide_step2_p3')}</li>
                                <li>{t('duckdns_guide_step3_p1')} <b>{t('integration_port_forwarding')}</b> {t('duckdns_guide_step3_p2')}</li>
                                <li>{t('duckdns_guide_step4_p1')} <b>80</b> {t('duckdns_guide_step4_p2')} <b>5173</b> ({t('dev_label')}) {t('or')} <b>3001</b> ({t('prod_label')}).</li>
