...
export { DoctorsPage } from '@/features/doctors/DoctorsPage';
...
export { DoctorsManager } from '@/features/doctors/components/views/DoctorsManager';
export { DoctorEditModal } from '@/features/doctors/components/modals/DoctorEditModal';
