    ...
    return (
        <div className={styles.DoctorFiscalWizard__root}>
            <div className={styles.DoctorFiscalWizard__stepper}>
                <div className={`${styles.DoctorFiscalWizard__step} ${step === 1 ? styles.active : ''}`}>{t('wizard_step1_title')}</div>
                <div className={`${styles.DoctorFiscalWizard__step} ${step === 2 ? styles.active : ''}`}>{t('wizard_step2_title')}</div>
                <div className={`${styles.DoctorFiscalWizard__step} ${step === 3 ? styles.active : ''}`}>{t('wizard_step3_title')}</div>
                <div className={`${styles.DoctorFiscalWizard__step} ${step === 4 ? styles.active : ''}`}>{t('wizard_step4_title')}</div>
            </div>
