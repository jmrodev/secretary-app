export const patients = {
    ...
    rating_conduct: "Behavior",
    edit_behavior_rating: "Edit Behavior Rating",
    behavior_rating_note_label: "Reason / What happened",
    behavior_rating_note_placeholder: "Explain what happened to justify the rating change...",
    behavior_rating_note_help: "This note will be recorded and shown on hover over the rating.",
    save_rating: "Save Rating",
    behavior_note_tooltip_prefix: "Reason:",
    behavior_rating_select_label: "Behavior score",
    behavior_rating_auto: "Automatic calculation",
    behavior_rating_auto_derived: "Automatic derived",
    behavior_rating_auto_hint: "System calculation: {rating}★ (Financial: {fin}★, Attendance: {att}★)",
    behavior_rating_manual_badge: "Manual",
    behavior_rating_reset_auto: "Reset to automatic",
    behavior_rating_note_required_warning: "A reason/note is required for manual rating changes.",
