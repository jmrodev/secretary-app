...
/**
 * SearchBar Molecule.
 * Encapsulates search input, icons, clear button, and suggestions dropdown.
 */
                ...
                {value && (
                    <div className={styles.SearchBar__actions}>
                        <Button 
                            ...
                            icon={<Icon name="close" size="0.9rem" />}
            ...
            {showSuggestions && suggestions.length > 0 && !value && (
                <div className={styles.SearchBar__suggestions}>
                    <header className={styles.SearchBar__suggestionsHeader}>
                        <Icon name="history" size="0.9rem" /> {labels.recentActivity}
                    </header>
                            ...
                            return (
                                ...
                                >
                                    <div className={styles.SearchBar__suggestionIcon}>
                                        <Icon name={item.type === 'patient' ? 'person' : 'calendar_today'} size="1rem" />
                                    </div>
