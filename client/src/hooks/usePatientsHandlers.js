...
export const usePatientsHandlers = ({
    ...
    // Data/State Access (if needed by handlers)
    patients,
    patientDetails,
    ...
    fetchPatients,
    fetchRecycleBin,
    handleViewDetails, // Needed for recursive updates (like debt payment)
}) => {
    ...
    }, [showMessage, setSelectedPatientId, setDetailsLoading, setPatientDetails]);
