...
CREATE TABLE `appointments` (
  ...
  KEY `idx_appt_google_event` (`google_event_id`),
  KEY `idx_appt_institution` (`institution_id`),
  KEY `idx_appt_doctor_status` (`doctor_id`,`status`),
...
CREATE TABLE `doctors` (
  ...
  `gemini_history_limit` int(11) DEFAULT 5,
...
CREATE TABLE `medical_licenses` (
  ...
  KEY `idx_license_start` (`start_date`),
  KEY `idx_license_payment` (`payment_status`),
...
CREATE TABLE `medical_requests` (
  ...
  KEY `idx_mr_payment_status` (`payment_status`),
...
) ENGINE=InnoDB AUTO_INCREMENT=8699 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `prescriptions` (
  ...
  PRIMARY KEY (`id`),
  KEY `appointment_id` (`appointment_id`),
  KEY `idx_presc_created` (`created_at`),
  KEY `idx_presc_payment` (`payment_status`),
...
-- Dump completed on 2026-05-03  2:31:11
