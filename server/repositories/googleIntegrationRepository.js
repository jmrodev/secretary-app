...
class GoogleIntegrationRepository {
    ...
    async findTokensByDoctorId(doctorId, conn = pool) {
    ...
    async upsertTokens(doctorId, tokens, conn = pool) {
    ...
    async findPendingSyncItems(limit = 10, conn = pool) {
