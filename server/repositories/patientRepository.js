...
const ALLOWED_UPDATES = [
    'user_id', 'first_name', 'last_name', 'full_name', 'dob',
    'phone', 'email', 'medical_history', 'dni', 'affiliate_number',
    'insurance_id', 'tariff_percent', 'tariff_override',
    'behavior_rating', 'is_new_patient', 'marked_new_at',
    'visit_interval_days', 'prescription_interval_days',
    'next_suggested_visit_date', 'next_suggested_prescription_date',
    'license_expiry_date', 'institution_id', 'street_name',
    'street_number', 'floor', 'apartment', 'city', 'province',
    'country', 'visit_notified', 'prescription_notified',
    'license_notified'
];
...
class PatientRepository {
    ...
    async update(id, updates, conn = pool) {
        ...
        const values = [...Object.values(validUpdates).map(v => v === '' ? null : v), id];
